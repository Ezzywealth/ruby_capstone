...
describe Label do
  let(:book1) { Book.new(1, 'Fantasy', 'J.R.R.', 'Tolkien', 'The Lord of the Rings', 'The Hobbit', 'red', 'bad', 'Allen & Unwin', '2010-10-12') }
  let(:book2) { Book.new(1, 'Comic', 'Donald', 'Trump', 'American Savage', 'Washington', 'blue', 'good', 'Barrack Obama', '2022-10-12') }
